...
namespace Movements
{
    ...
    public class RbMovement: MonoBehaviour
    {
        ...
        // Add inside RbMovement.cs (public methods)
        public void SetPrivateSpeedMultiplier(float multiplier)
        {
            _horizontalSpeed *= multiplier;
        }

        public void SetPrivateJumpMultiplier(float multiplier)
        {
